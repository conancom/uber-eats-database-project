...
INSERT INTO `client` (`ClientID`, `Password`, `Email`, `Gender`, `DateOfBirth`, `FName`, `LName`, `Address`, `Registration_TimStamp`, `Occoupation`, `PhoneNumber`) VALUES
(1, 'leon', 'leon@email.com', 'Male', '2000-06-26', 'Leon', 'Wirz', '88/218 bangbuathong', '2021-11-11 13:41:24.93', 'Student', '0824345775');
...
--
ALTER TABLE `restaurant`
  MODIFY `RestaurantID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
